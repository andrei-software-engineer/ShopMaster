    ...
    <div class="row bg-light m-0 p-md-4 p-3 border-top rounded-bottom">
        ...
        <div class="col-md-6 my-2">
            ...
            <p class="ms-md-5 ps-md-1">
                ...
                <a href="https://laravel.com/docs" target="" class="text-u-l">documentation</a> from start to
                finish.
            </p>
        </div>
        ...
        <div class="col-md-6 my-2">
            ...
            <p class="ms-md-5 ps-md-1">
                ...
                <a href="https://orchid.software/en/docs/quickstart" target="" class="text-u-l"> see on the
                    site</a>.
            </p>
        </div>
