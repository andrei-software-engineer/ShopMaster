<div class="message">
    <div class="d-flex justify-content-between pb-2">
        ...
        <div class="button_add">
            <button  class="js_CA_click btn btn-default" data-toggleinfo="#messageAdmin" type="button"><x-orchid-icon path="plus" class="me-2"/>{{ _GL('Add') }}</button>
        </div>
    </div>
    ...
    <div style="display: none" id="messageAdmin">
        ...
        <table class="table table-light" >
            <td>
                <div >
                    <form method="POST" action="{{ route('platform.ordermessage') }}" enctype="multipart/form-data"  >
