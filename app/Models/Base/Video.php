...
class Video extends BaseModel 
{
    ...
    public function processObject($obj, $params)
    {
            ...
            || (isset($params['_full']) && $params['_full'] == '1'))
        {
            ...
            $obj->systemvideoobj = SystemVideo::GETFILE($obj->idsystemvideo);
            $obj->url = SystemVideo::PARSE_URL($obj->idsystemvideo);
            ...
            {
                $obj->name_show = (isset($obj->_name) && $obj->_name) ? $obj->_name : $obj->systemvideoobj->name;
                $obj->standardScript = $obj->systemvideoobj->script;
            } else{
