...
class FaqResponsesLayout extends Table
{
    /**
     * Data source.
     *
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            TD::make('id','ID')
                ->sort()
                ->filter(Input::make())
                ->render(function (FaqResponses $obj) {
                    return Link::make($obj->id)
                        ->route('platform.faqresponses.edit',$obj->_getModifyAdminParams());}),
            ...
            TD::make(__('Actions'))
                ...
                ->width('100px')
                ->render(fn (FaqResponses $obj) => DropDown::make()
                    ...
                    ->list([
                        ...
                        Button::make(__('Delete'))
                            ...
                            ->action(route('platform.faqresponses.remove', $obj->_getFiltersMedia()))
